...
static const char *const yytname[] =
{
  ...
  "HEXADECIMAL", "DECIMAL", "EOL", "$accept", "input", "line", "number", YY_NULLPTR
};
...
#line 30 "yacc.y"
               {
        convert_and_print((yyvsp[-1].s));
        free((yyvsp[-1].s));
    }
#line 1069 "yacc.tab.c"
    break;

  case 5: /* number: BINARY  */
#line 37 "yacc.y"
                  { (yyval.s) = (yyvsp[0].s); }
#line 1075 "yacc.tab.c"
    break;

  case 6: /* number: HEXADECIMAL  */
#line 38 "yacc.y"
                  { (yyval.s) = (yyvsp[0].s); }
#line 1081 "yacc.tab.c"
    break;

  case 7: /* number: DECIMAL  */
#line 39 "yacc.y"
                  { (yyval.s) = (yyvsp[0].s); }
